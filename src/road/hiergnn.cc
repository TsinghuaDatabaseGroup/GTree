/* ----------------------------------------------------------------------------
    ...
    Suggested arguments:
    > (prog name) -h hiergraph.idx -o object.dat -q #queries -s #srcs -k k -v
    explanations:
...
int main(const int a_argc, const char** a_argv)
{
    ...
    cerr << "group kNN object search on hierarchical graph" << endl;
    //-------------------------------------------------------------------------
    // initialization
    //-------------------------------------------------------------------------
    ...
    for (int i=0; i<numquery; i++)
    {
        ...
        HierObjectSearch::groupKNNSearch(
            hiergraph, nmap, gmap,
            src, numsrc, k, 
