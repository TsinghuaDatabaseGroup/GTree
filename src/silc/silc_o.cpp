...
#define FILE_EDGE "../../src/data/col.cedge"

#define FILE_MORTON "./data/col.morton"
...
#define FILE_OBJECT "../../common_data/col.object.dat.43000"
#define FILE_QUERY "../../common_data/col.query.dat"
...
//            knn_query(query_location[i],5,o,result); 
            ...
            // K = 10
            TIME_TICK_START
            knn_query(query_location[i],10,o,result);    
            TIME_TICK_END
            total_time_10 += te - ts;
...
//            knn_query(query_location[i],50,o,result);
    ...
    printf("TOTAL 1: %lld AVG: %lld\n", total_time_1, total_time_1 / object_size / query_location.size() );
    printf("TOTAL 5: %lld AVG: %lld\n", total_time_5, total_time_5 / object_size / query_location.size() );
    printf("TOTAL 10: %lld AVG: %lld\n", total_time_10, total_time_10 / object_size / query_location.size() );
    printf("TOTAL 20: %lld AVG: %lld\n", total_time_20, total_time_20 / object_size / query_location.size() );
    printf("TOTAL 50: %lld AVG: %lld\n", total_time_50, total_time_50 / object_size / query_location.size() );	
